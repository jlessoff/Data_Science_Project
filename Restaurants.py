...
results = client.get("43nn-pn8j", select='date_trunc_ymd(inspection_date),zipcode,camis,cuisine_description,violation_code,grade,violation_description,score, critical_flag,inspection_type,latitude,longitude', limit=3000)
